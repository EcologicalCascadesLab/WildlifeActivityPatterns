---
title: "Rarer 59 Specialists Multinomial Model Selection and Visualization"
author: "Samuel Xin Tham Lee"
date: "2023-10-03"
output: html_document
---

Here, we will carry out model selection to observe whether forest integrity, body mass(in kg)/body size (i.e., large, medium, and small), and feeding guild (i.e., carnivore, herbivore, and omnivore) contributes to the model for the 59 rarer forest specialists.
...
###Removing pigs and macaques from the captures dataframe
...
#save the table
write.csv(aic_table, "specialists_AIC_scores_[landscape_only]_20231004.csv", row.names = F)
...
#save it
write.csv(c, "specialists_sumstats_[landscape_only]_20231004.csv", row.names = F)
...
#save it
write.csv(c, "specialists_sumstats_[landscape_only]_20231030.csv", row.names = F)
...
#save it
ggsave("specialists_plot_[landscape_only]_20231004.PDF", plot = plot, height = 6, width = 8, units = "in")
...
#save the table
write.csv(aic_table, "specialists_AIC_scores_[landscape_species]_20231004.csv", row.names = F)
...
```{r}
#Subset best model 
a = models[[6]] #Best model:time_of_day ~ disturbance_index * Body_size
b = summary(a)
c = as.data.frame(b$coefficients)
...
#save it
write.csv(c, "specialists_sumstats_[landscape_species]_20231004.csv", row.names = F)
...
#save it
write.csv(c, "specialists_sumstats_[landscape_species]_20231030.csv", row.names = F)
...
#save it
ggsave("specialists_plot_[landscape_species]_20231004.PDF", plot = plot, height = 6, width = 8, units = "in")
